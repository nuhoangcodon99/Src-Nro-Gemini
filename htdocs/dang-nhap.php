...
$_title = "Ngọc Rồng Gemini - Đăng Nhập";
if ($_login == null) {
                ...
                <div class="col">
                    ...
                    <div class="text-center pt-2">
                        <div style="display: inline-block;">
                            <a href="../download/Gemini.apk"> <img class="icon-download" src="../image/android.png">
                            </a><br>
                        ...
                        <div style="display: inline-block;">
                            <a href="../download/Gemini.rar"><img class="icon-download" src="../image/pc.png">
                            </a><br>
                            <small class="text-dark">
                                <?php echo $_windows; ?>
                            </small>
                        ...
                        <div style="display: inline-block;">
                        <a href="../download/Gemini.ipa"><img class="icon-download" src="../image/ip.png">
						</a><br>
                            <small class="text-dark">
                                <?php echo $_iphone; ?>
                            </small>
                        ...
                        <div style="display: inline-block;">
                        <a href="https://zalo.me/g/mefpph695"><img class="icon-download" src="../image/zalo.png">
						</a><br>
                            <small class="text-dark">
                                <?php echo $_Zalo; ?>
                            </small>
