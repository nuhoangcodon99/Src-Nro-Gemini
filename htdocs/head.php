...
<head>
    ...
    <base href="">
    <title>Ngọc Rồng Gemini</title>
    <meta name="description"
        content="ngocrong,ngocrongonline,ngocrongGemini.online,7vienngocrong,nro">
    <meta name="keywords"
        content="Ngọc Rồng Gemini - Máy Chủ Ngọc Rồng Online Online,ngoc rong mobile, game ngoc rong, game 7 vien ngoc rong, game bay vien ngoc rong">
    ...
    <meta name="twitter:description"
        content="Website chính thức của Ngọc Rồng Gemini - Máy Chủ Ngọc Rồng Online Online – Game Bay Vien Ngoc Rong Mobile nhập vai trực tuyến trên máy tính và điện thoại về Game 7 Viên Ngọc Rồng hấp dẫn nhất hiện nay!">
                ...
                <div class="col">
                    ...
                    <div class="text-center pt-2">
                        <div style="display: inline-block;">
                            <a href="https://www.facebook.com/bengokyeuanh.99"> <img class="icon-download" src="../image/android.png">
                            </a><br>
                        ...
                        <div style="display: inline-block;">
                            <a href="https://www.facebook.com/bengokyeuanh.99"><img class="icon-download" src="../image/pc.png">
                            </a><br>
                            <small class="text-dark">
                        ...
                        <div style="display: inline-block;">
                        <a href="https://www.facebook.com/bengokyeuanh.99"><img class="icon-download" src="../image/ip.png">
						</a><br>
                            <small class="text-dark">
                        ...
                        <div style="display: inline-block;">
                        <a href="https://www.facebook.com/bengokyeuanh.99"><img class="icon-download" src="../image/zalo.png">
						</a><br> 
                            <small class="text-dark">
